...
APConstraints &APConstraints::withVelocity(units::meters_per_second_t newVelocity)
{
    velocity = newVelocity;
    return *this;
}

APConstraints &APConstraints::withAcceleration(units::meters_per_second_squared_t newAcceleration)
{
